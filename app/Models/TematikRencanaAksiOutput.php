    ...
    public function getActivitylogOptions(): LogOptions
    {
        return LogOptions::defaults()
            ->logOnly([
                ...
                'pelaksana',
                'koordinator',
                'realisasi_output_tw1',
                'realisasi_output_tw2',
                'realisasi_output_tw3',
                'realisasi_output_tw4',
                'realisasi_output_total',
                'realisasi_anggaran_tw1',
                'realisasi_anggaran_tw2',
                'realisasi_anggaran_tw3',
                'realisasi_anggaran_tw4',
                'realisasi_anggaran_total',
                'capaian_output_tw1',
                'capaian_output_tw2',
                'capaian_output_tw3',
                'capaian_output_tw4',
                ...
                'capaian_anggaran_tw2',
                'capaian_anggaran_tw3',
                'capaian_anggaran_tw4',
                'capaian_anggaran_total',
                'fokus_intervensi',
                'catatan'
            ]);
    }
