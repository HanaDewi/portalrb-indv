...
class EvaluasiSakipController extends Controller
{
    ...
    /**
     * Menampilkan halaman daftar tim evaluasi
     */
    public function tim_evaluasi()
    {
        ...
        if (!$anggota || !$anggota->tim) {
            return view('akip.evaluasi.tim-list', [
                'tim' => null,
        ...
        return view('akip.evaluasi.tim-list', compact('tim'));
    }
     ...
     */
    public function tim_evaluasi_getInstansi($user_id)
    {
        // Check akses hanya untuk TPN
        if ($this->currentUser->level !== 'tpn') {
