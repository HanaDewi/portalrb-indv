    ...
    {   
        ...
        if(Auth::User()->level =="admin" || Auth::User()->level == "tpn" ){
            ...
            return view('zi.rekap.rekap_total', compact(
                "title","instansi_ZIs", "total_instansi", "total_wbk", "total_wbbm", "total_instansi_final","total_wbk_final", "total_wbbm_final",
                
                'total_instansi_administrasi','total_wbk_administrasi','total_wbbm_administrasi',
                'total_instansi_sanggah','total_wbk_sanggah','total_wbbm_sanggah',
