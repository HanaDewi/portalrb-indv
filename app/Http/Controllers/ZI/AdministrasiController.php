...
class AdministrasiController extends Controller
{
    ...
    {   
        ...
        $valTlhp= ($seleksiAdministrasiInstansi)?$seleksiAdministrasiInstansi->tlhp:Null;
        $valCatatanTlhp = ($seleksiAdministrasiInstansi)?$seleksiAdministrasiInstansi->catatan_tlhp:Null;
        $valSurveiMandiri= ($seleksiAdministrasiInstansi)?$seleksiAdministrasiInstansi->survei_mandiri:Null;
        $valCatatanSurveiMandiri = ($seleksiAdministrasiInstansi)?$seleksiAdministrasiInstansi->catatan_survei_mandiri:Null;
        return view('zi.seleksi_administrasi.evaluasi', compact(
            "title","instansi_ZI","unit_wbk_ZIs","unit_wbbm_ZIs","seleksiAdministrasiInstansi",
            "valSuratUsulan", "valCatatanSuratUsulan", "valSptjm","valCatatanSptjm",
            "valTlhp","valCatatanTlhp","valSurveiMandiri","valCatatanSurveiMandiri"
            ));
    ...
    public function evaluasi_administrasi_simpan(Request $request){
        ...
        $tlhp = $request->get('tlhp');
        $catatanTlhp =$request->get('catatanTlhp');
        $surveiMandiri =$request->get('surveiMandiri');
        $catatanSurveiMandiri = $request->get('catatanSurveiMandiri');
        ...
        $seleksiAdministrasiInstansi->tlhp = $tlhp;
        $seleksiAdministrasiInstansi->catatan_tlhp = $catatanTlhp;
        $seleksiAdministrasiInstansi->survei_mandiri = $surveiMandiri;
        $seleksiAdministrasiInstansi->catatan_survei_mandiri = $catatanSurveiMandiri;
