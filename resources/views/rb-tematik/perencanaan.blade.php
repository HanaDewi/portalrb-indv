    ...
    <div id="modal-monev-indikator-roadmap" class="modal fade" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <!-- BEGIN: Modal Header -->
                <div class="darkbg modal-header">
                    <h2 class="font-bold fw-medium fs-base me-auto" id="title">Monitoring dan Evaluasi Indikator
            ...
            <div class="modal-content">
                ...
                <form action="{{ url('rencana_aksi/rb-tematik/perencanaan/import') }}" id="form-import_rencana_aksi" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body grid columns-12 gap-4 gap-y-3">
                        ...
                        <div class="g-col-12">
                            <span class="text-danger font-bold"><i>* RB Tematik yang diupload harus sesuai dengan template
                                    yang diberikan</i></span>
                        </div>
                    </div> <!-- END: Modal Body -->
                    <!-- BEGIN: Modal Footer -->
                    <div class="modal-footer text-end">
...
@push('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            modal_monev_indikator_roadmap = tailwind.Modal.getInstance(document.querySelector(
                "#modal-monev-indikator-roadmap"));
        ...
        function hapus_sasaran_roadmap(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ url('rencana_aksi/rb-tematik/perencanaan/sasaran_roadmap/') }}/hapus/" +
                            id,
                        type: "post",
                        data: {
                            _token: '{{ csrf_token() }}',
                        ...
                        success: function(terhapus) {
                            if (terhapus.success) {
                                Swal.fire('Selamat!', 'Data Sasaran Roadmap berhasil dihapus!',
                                    'success');
                                Swal.fire({
                                    title: "'Selamat!",
                                    text: 'Data Sasaran Roadmap berhasil dihapus!! ' + terhapus
                                        .pesan,
                                    icon: 'warning',
                                    confirmButtonColor: "#DD6B55",
                                    confirmButtonText: "Ya, Hapus aja!"
                                ...
                                Swal.fire('Aduh!', 'Data sasaran Roadmap gagal dihapus! ' + terhapus
                                    .pesan, 'error');
                            }
                        },
                        error: function(err) {
                            Swal.fire('Error!',
                                'Terjadi kesalahan! <br/> Pastikan menghapus dahulu indikator roadmap yang terkait dengan sasaran ini',
                                'error');
                        }
                    });
                }
        ...
        function hapus(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ url('rencana_aksi/rb-tematik/perencanaan/indikator_roadmap/') }}/hapus/" +
                            id,
                        type: "post",
                        data: {
                            _token: '{{ csrf_token() }}',
                        ...
                        success: function(terhapus) {
                            if (terhapus.success) {
                                Swal.fire('Selamat!', 'Data Indikator Roadmap berhasil dihapus!',
                                    'success');
                                Swal.fire({
                                    title: "'Selamat!",
                                    text: 'Data Indikator Roadmap berhasil dihapus!! ' +
                                        terhapus.pesan,
                                    icon: 'warning',
                                    confirmButtonColor: "#DD6B55",
                                    confirmButtonText: "Ya, Hapus aja!"
                                ...
                                Swal.fire('Aduh!', 'Data indikator Roadmap gagal dihapus! ' + terhapus
                                    .pesan, 'error');
                            }
                        },
                        error: function(err) {
                            Swal.fire('Error!',
                                'Terjadi kesalahan! <br/> Pastikan menghapus dahulu permalasahan yang terkait dengan indikator roadmap ini',
                                'error');
                        }
                    });
                }
