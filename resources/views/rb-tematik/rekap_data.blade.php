                ...
                @if (in_array(auth()->user()->level, ['admin', 'evaluator']))
                    <div class="p-5">
                        <form>
                            ...
                            {!! Form::select('instansi_id', instansis(), $instansi_id, [
                                'class' => 'mt-2',
                                'id' => 'instansi_id',
                                'data-placeholder' => 'Pilih Kegiatan Utama',
                                'required',
                            ]) !!}
                ...
                <table id="perencanaan" class="table table-bordered table-striped" cellspacing="0" width="100%">
                    <thead class="table-dark font-bold">
                        <tr>
                            ...
                            <th class="w-10" rowspan="2">Sasaran Tematik Roadmap</th>
                            <th class="w-10" rowspan="2">Indikator</th>
                            <th rowspan="2">Target</th>
                            <th class="w-5" rowspan="2">Permasalahan (bottleneck)</th>
                            <th class="w-10" rowspan="2">Sasaran</th>
                            <th class="w-10" rowspan="2">Indikator</th>
                            <th class="w-10" rowspan="2">Target</th>
                            <th class="w-15" rowspan="2">Rencana Aksi</th>
                            <th class="w-5" colspan="2" style="text-align: center;">Output</th>
                            <th class="w-5" rowspan="2" style="text-align: center;">Aspek Tata Kelola</th>
                            <th class="w-5" rowspan="2" style="text-align: center;">Target</th>
                            <th class="w-5" rowspan="2" style="text-align: center;">Jenis Kegiatan Aksi</th>
                            <th class="w-5" rowspan="2" style="text-align: center;">Jumlah Anggaran</th>
                            <th class="w-5" colspan="2" style="text-align: center;">Unit/Satuan Kerja Pelaksana</th>
                            <th class="w-5" rowspan="2">Realisasi</th>
                            <th class="w-5" rowspan="2">% capaian</th>
                            <th class="w-5" rowspan="2">Realisasi Anggaran</th>
                        </tr>
                        <tr>
                            <th>Satuan</th>
                            <th>Indikator</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if (auth()->user()->level == 'evaluator')
                                        <button onclick="catatan({{ $data['perencanaan']->id }});"
                                            class="mb-3 btn btn-warning btn-sm w-10"><svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <td>
                                    @if ($data['output']->target_total)
                                        <table class="table table-noborder">
                                            <tr>
                                                <th>TW 1</th>
                                                <td>: {{ fnumber($data['output']->target_tw1) }}</td>
                                            </tr>
                                            <tr>
                                                <th>TW 2</th>
                                                <td>: {{ fnumber($data['output']->target_tw2) }}</td>
                                            </tr>
                                            <tr>
                                                <th>TW 3</th>
                                                <td>: {{ fnumber($data['output']->target_tw3) }}</td>
                                            </tr>
                                            <tr>
                                                <th>TW 4</th>
                                                <td>: {{ fnumber($data['output']->target_tw4) }}</td>
                                            </tr>
                                            <tr>
                                                <th>Total</th>
                                                <td>: {{ fnumber($data['output']->target_total) }}</td>
                                            </tr>
                                        </table>
                                    @endif
                                </td>
                                <td>
                                    @if ($data['output']->anggaran_total)
                                        <table class="table table-noborder">
                                            <tr>
                                                <th>TW 1</th>
                                                <td>: {{ fnumber($data['output']->anggaran_tw1) }}</td>
                                            </tr>
                                            <tr>
                                                <th>TW 2</th>
                                                <td>: {{ fnumber($data['output']->anggaran_tw2) }}</td>
                                            </tr>
                                            <tr>
                                                <th>TW 3</th>
                                                <td>: {{ fnumber($data['output']->anggaran_tw3) }}</td>
                                            </tr>
                                            <tr>
                                                <th>TW 4</th>
                                                <td>: {{ fnumber($data['output']->anggaran_tw4) }}</td>
                                            </tr>
                                            <tr>
                                                <th>Total</th>
                                                <td>: {{ fnumber($data['output']->anggaran_total) }}</td>
                                            </tr>
                                        </table>
                                    @endif
                                </td>
                                ...
                                <td>
                                    @if ($data['output']->realisasi_output_total)
                                        <table class="table table-noborder">
                                            <tr>
                                                <th>TW 1</th>
                                                <td>: {{ fnumber($data['output']->realisasi_output_tw1) }}</td>
                                            </tr>
                                            <tr>
                                                <th>TW 2</th>
                                                <td>: {{ fnumber($data['output']->realisasi_output_tw2) }}</td>
                                            </tr>
                                            <tr>
                                                <th>TW 3</th>
                                                <td>: {{ fnumber($data['output']->realisasi_output_tw3) }}</td>
                                            </tr>
                                            <tr>
                                                <th>TW 4</th>
                                                <td>: {{ fnumber($data['output']->realisasi_output_tw4) }}</td>
                                            </tr>
                                            <tr>
                                                <th>Total</th>
                                                <td>: {{ fnumber($data['output']->realisasi_output_total) }}</td>
                                            </tr>
                                        </table>
                                    @endif
                                </td>
                                <td>
                                    @if ($data['output']->realisasi_anggaran_total)
                                        <table class="table table-noborder">
                                            <tr>
                                                <th>TW 1</th>
                                                <td>: {{ fnumber($data['output']->realisasi_anggaran_tw1) }}</td>
                                            </tr>
                                            <tr>
                                                <th>TW 2</th>
                                                <td>: {{ fnumber($data['output']->realisasi_anggaran_tw2) }}</td>
                                            </tr>
                                            <tr>
                                                <th>TW 3</th>
                                                <td>: {{ fnumber($data['output']->realisasi_anggaran_tw3) }}</td>
                                            </tr>
                                            <tr>
                                                <th>TW 4</th>
                                                <td>: {{ fnumber($data['output']->realisasi_anggaran_tw4) }}</td>
                                            </tr>
                                            <tr>
                                                <th>Total</th>
                                                <td>: {{ fnumber($data['output']->realisasi_anggaran_total) }}</td>
                                            </tr>
                                        </table>
                                    @endif
                                </td>
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <div class="darkbg modal-header">
                        <h2 class="font-bold fw-medium fs-base me-auto" id="title">Monitoring dan Evaluasi Perencanaan
                        </h2>
