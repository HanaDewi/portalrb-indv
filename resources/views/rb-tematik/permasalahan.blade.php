                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if ($tematikData['permasalahan_nama'])
                                        <a href="#" class="btn btn-pending btn-sm w-full mb-2" onclick="editPermasalahan('{{ $tematikData['permasalahan_id'] }}')">
                                        ...
                                        <br />
                                        <a href="#" class="btn btn-danger btn-sm w-full mb-2" onclick="hapusPermasalahan('{{ $tematikData['permasalahan_id'] }}')">
                                ...
                                <td>
                                    @if ($tematikData['indikator_permasalahan_nama'])
                                        ...
                                        <br />
                                        <a href="#" class="btn btn-pending btn-sm w-full mb-2" onclick="edit('{{ $tematikData['indikator_permasalahan_id'] }}')">
                                        ...
                                        <br />
                                        <a href="#" class="btn btn-danger btn-sm w-full mb-2" onclick="hapus_indikator('{{ $tematikData['indikator_permasalahan_id'] }}')">
