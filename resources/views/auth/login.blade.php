            ...
            <div class="block xl:grid grid-cols-2 gap-4">
                <div class="hidden xl:flex flex-col min-h-screen">
                    ...
                    <div class="my-auto">
                        ...
                        <div class="-intro-x text-black font-medium text-4xl leading-tight mt-10">
                            Kementerian Pendayagunaan
                            <br>
                            Aparatur Negara dan <br>
                            Reformasi Birokrasi
                        </div>
                        <div class="-intro-x mt-5 text-lg text-black text-opacity-70 dark:text-slate-400">Sistem Informasi
