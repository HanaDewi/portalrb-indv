...
<div class="intro-y col-span-12 lg:col-span-12">
    ...
    <div class="intro-y box">
        <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60">
            <h2 class="font-bold text-base mr-auto"> Rekap Unit </h2>
        </div>
        <br />
        <!--
            ...
            <table id="rekap-zi" class="table table-bordered table-striped" cellspacing="0" width="100%">
                <thead class="table-dark font-bold">
                    <tr>
                        ...
                        <th colspan=4>Surat Usulan </th>
                        <th colspan=4>Sptjm</th>
                        <th colspan=4>LKE</th>
                        <th colspan=4>TLHP</th>
                        <th colspan=4>Survei Mandiri</th>
                        <th colspan=4>2 Tahun WBK</th>
                        <th colspan=2>Status Completed</th>
                        <th colspan=2>Status Final</th>
                    </tr>
                    <tr>
                        <th>Status Administrasi</th>
                        <th>Link Sanggah</th>
                        <th>Status Sanggah</th>
                        <th>Catatan Sanggah</th>
                        <th>Status Administrasi</th>
                        <th>Link Sanggah</th>
                        <th>Status Sanggah</th>
                        <th>Catatan Sanggah</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            {{$unit_ZI->instansiZI->administrasi_instansi->surat_usulan}}
                            @endif
                        </td>
                        <td>
                            @if($unit_ZI->instansiZI->sanggah_instansi)
                            {{$unit_ZI->instansiZI->sanggah_instansi->surat_usulan}}
                            @endif
                        </td>
                        <td>
                            @if($unit_ZI->instansiZI->sanggah_instansi)
                            {{$unit_ZI->instansiZI->sanggah_instansi->status_surat_usulan}}
                            @endif
                        </td>
                        <td>
                            @if($unit_ZI->instansiZI->sanggah_instansi)
                            {{$unit_ZI->instansiZI->sanggah_instansi->catatan_surat_usulan}}
                            @endif
                        </td>
                        <td>
                            @if($unit_ZI->instansiZI->administrasi_instansi)
                        ...
                        <td>
                            @if($unit_ZI->instansiZI->sanggah_instansi)
                            {{$unit_ZI->instansiZI->sanggah_instansi->sptjm}}
                            @endif
                        </td>
                        <td>
                            @if($unit_ZI->instansiZI->sanggah_instansi)
                            {{$unit_ZI->instansiZI->sanggah_instansi->status_sptjm}}
                            @endif
                        </td>
                        <td>
                            @if($unit_ZI->instansiZI->sanggah_instansi)
                            {{$unit_ZI->instansiZI->sanggah_instansi->catatan_sptjm}}
                            @endif
                        </td>
                        <td>
                            @if($unit_ZI->seleksi_administrasi_unit)
                            {{$unit_ZI->seleksi_administrasi_unit->status_lke}}
                            @endif
                        </td>
                        <td>
                        ...
                        <td>
                            @if($unit_ZI->sanggah_unit)
                            {{$unit_ZI->sanggah_unit->status_lke}}
                            @endif
                        </td>
                        <td>
                            @if($unit_ZI->sanggah_unit)
                        ...
                        <td>
                            @if($unit_ZI->sanggah_unit)
                            {{$unit_ZI->sanggah_unit->status_tlhp}}
                            @endif
                        </td>
                        <td>
                            @if($unit_ZI->sanggah_unit)
                        ...
                        <td>
                            @if($unit_ZI->seleksi_administrasi_unit)
                            {{$unit_ZI->seleksi_administrasi_unit->status_survei_mandiri}}
                            @endif
                        </td>
                        <td>
                            @if($unit_ZI->sanggah_unit)
                        ...
                        <td>
                            @if($unit_ZI->sanggah_unit)
                            {{$unit_ZI->sanggah_unit->status_survei_mandiri}}
                            @endif
                        </td>
                        <td>
                            @if($unit_ZI->sanggah_unit)
                        ...
                        <td>
                            @if($unit_ZI->sanggah_unit)
                            {{$unit_ZI->sanggah_unit->status_2wbk}}
                            @endif
                        </td>
                        <td>
                            @if($unit_ZI->sanggah_unit)
                        ...
                        <td>
                            @if($unit_ZI->seleksi_administrasi_unit)
                            {{$unit_ZI->seleksi_administrasi_unit->status_completed}}
                            @endif
                        </td>
                        <td>
                            @if($unit_ZI->sanggah_unit)
                            {{$unit_ZI->sanggah_unit->status_completed}}
                            @endif
                        </td>
                        <td>
                            @if($unit_ZI->seleksi_administrasi_unit)
                        ...
                        <td>
                            @if($unit_ZI->sanggah_unit)
                            {{$unit_ZI->sanggah_unit->status_final}}
                            @endif
                        </td>
                    </tr>
                    @endforeach
