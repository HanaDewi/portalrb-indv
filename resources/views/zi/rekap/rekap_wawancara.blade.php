            ...
            <table id="rekap-zi" class="table table-bordered table-striped" cellspacing="0" width="100%">
                <thead class="table-dark font-bold">
                    <tr>
                        ...
                        <th>WBK/WBBM</th>
                        <th>LKE Evaluator </th>
                        <th>Paparan Evaluatan</th>
                        <th>Jadwal dan link zoom</th>
                        <th>Status</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            {{$unit_ZI->wawancara->link_paparan}}
                            @endif
                        </td>
                        <td>
                            @if($unit_ZI->wawancara)
                            Jadwal :
                            {{\Carbon\Carbon::parse($unit_ZI->wawancara->jadwal)->isoFormat('dddd, D
                            MMMM Y HH:mm');}}
                            <br /><br />
                            <hr />
                            Link Zoom : {{$unit_ZI->wawancara->link_zoom}}
                            @endif
                        </td>
                        <td>
                            @if($unit_ZI->wawancara)
