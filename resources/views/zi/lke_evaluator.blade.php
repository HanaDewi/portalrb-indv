    ...
    <div class="intro-y box">
                        ...
                        <div class="w-3/4 flex-none">
                            ...
                            <div class="text-gray-800 mt-2 text-xl">
                                ...
                                <a href="#c" id="unitTotal">
                                    <b> {{$wbk_non_mandiri_count+$wbbm_count}} <sup
        ...
        <div class="lg:col-span-12 p-5 border-b border-slate-200/60">
            <div class="separator mt-5">
                ...
                <a href="{{route('download_template_lke')}}" class="btn btn-primary">Download Template</a>
                @endif
            </div>
            <br />
            <table id="rekap-zi" class="table table-bordered table-striped" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    @if(($unit_ZI->instansiZI->instansi_wbk_mandiri AND $unit_ZI->wbbm) OR
                    !$unit_ZI->instansiZI->instansi_wbk_mandiri)
                    ...
                    <tr>
                        ...
                        <td>
                            @php
                            $teams = $unit_ZI->unit_tim->map->tim->unique()->pluck('nama') ;
