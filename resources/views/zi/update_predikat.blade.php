...
<div class="intro-y col-span-12 lg:col-span-12">
    ...
    <div class="intro-y box">
        <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60">
            <h2 class="font-bold text-base mr-auto"> Update Predikat - {{ auth()->user()->nama }}</h2>
        </div>
            ...
            <table id="rekap-zi" class="table table-bordered table-striped" cellspacing="0" width="100%">
                <thead class="table-dark font-bold">
                    <tr>
                        ...
                        <th>Maturitas SPIP</th>
                        <th>Predikat Diupdate Oleh</th>
                        <th>Edit</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{$instansi_ZI->opini_bpk}}</td>
                        <td class="text-center">{{$instansi_ZI->indeks_rb}}</td>
                        <td class="text-center">{{$instansi_ZI->predikat_sakip}}</td>
                        <td class="text-center">{{$instansi_ZI->maturitas_spip}}</td>
                        <td class="text-center">{{$instansi_ZI->update_predikat_by}}</td>
                        <td class="text-center">
                            <a href="{{route('edit_predikat',$instansi_ZI->id)}}" class="btn btn-danger"><i
                                    class="fa fa-edit"></i>
                                &nbsp; Edit </a>
                        </td>
                    </tr>
