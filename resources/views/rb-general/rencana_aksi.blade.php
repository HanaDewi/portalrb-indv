...
<div id="modal-import_rencana_aksi" class="modal fade" tabindex="-1" aria-hidden="true">
...
<script>
    $(document).ready(function() {
        ...
        $('#file_rencana_aksi').change(function() {
            cek_file(this);
        })
    });
    ...
    function importRencanaAksi() {
        modal_import_rencana_aksi.show();
    }
    ...
    function cek_file(input) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function(e) {
                ...
                if (ext != 'xlsx') {
                    Swal.fire("Perhatian", "File yang di input tidak sesuai ketentuan (xlsx). Silahkan download template RB General Rencana Aksi terlebih dahulu!", "error");
