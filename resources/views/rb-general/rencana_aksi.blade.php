            ...
            { 
                render: function (data, type, row, meta) {
                    return '<table class="table table-noborder">'+
                            '<tr><td> TW 1</td><td>: '+formatNumber(row.target_tw1)+ '</td></tr>'+
                            '<tr><td> TW 2</td><td>: '+formatNumber(row.target_tw2)+ '</td></tr>'+
                            '<tr><td> TW 3</td><td>: '+formatNumber(row.target_tw3)+ '</td></tr>'+
                            '<tr><td> TW 4</td><td>: '+formatNumber(row.target_tw4)+ '</td></tr>'+
                            '<tr><td> Total</td><td>: '+formatNumber(row.target_total)+'</td></tr>'+
                        '</table>';
                }
            },
            { 
