                ...
                @foreach ($datas as $data)
                    ...
                    @endphp
                        <tr>
                            ...
                            <td>
                            <a href="" class="btn btn-dark btn-sm w-full mb-2"><i data-lucide="edit" class="w-4 h-4 mr-1"></i> Edit</a>
                            <a href="" class="btn btn-primary btn-sm w-full mb-2"><i data-lucide="trash-2" class="w-4 h-4 mr-1"></i> Hapus</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
