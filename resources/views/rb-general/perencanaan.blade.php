                        ...
                        @if (count($indikator->target))
                            @foreach ($indikator->target as $target)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('renvana_aksi/rb-general/perencanaan/' . $indikator->perencanaan_id . '/' . $target->id . '/rencana_aksi') }}" class="btn btn-primary btn-sm w-full mb-2">
                                        ...
                                        <br>
                                        <a href="{{ url('renvana_aksi/rb-general/perencanaan/' . $indikator->perencanaan_id . '/' . $target->id . '/monev') }}"
                            ...
                            <tr>
                                ...
                                <td>
                                    @foreach ($indikator->target as $key => $target)
                                        ...
                                        <a href="{{ url('renvana_aksi/rb-general/perencanaan/' . $indikator->perencanaan_id . '/' . $target->id . '/rencana_aksi') }}"
...
<div id="modal-baseline" class="modal fade" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- BEGIN: Modal Body -->
            <form action="{{ url('renvana_aksi/rb-general/perencanaan/hapusBaseline') }}" id="form-hapus-baseline" method="post">
                @csrf
                <input type="hidden" name="perencanaan_id" id="baseline_perencanaan_id">
            </form>
            <form action="{{ url('renvana_aksi/rb-general/perencanaan/simpanBaseline') }}" id="form-baseline" method="post">
                @csrf
...
<div id="modal-target" class="modal fade" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- BEGIN: Modal Body -->
            <form action="{{ url('renvana_aksi/rb-general/perencanaan/simpanTarget') }}" id="form-target" method="post">
                @csrf
...
<div id="modal-monev" class="modal fade" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <!-- BEGIN: Modal Body -->
            <form action="{{ url('renvana_aksi/rb-general/perencanaan/simpanMonev') }}" id="form-monev" method="post">
                @csrf
...
<div id="modal-dokumen" class="modal fade" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <!-- BEGIN: Modal Body -->
            <form action="{{ url('renvana_aksi/rb-general/perencanaan/simpanDokumen') }}" id="form-dokumen" method="post" enctype="multipart/form-data">
                @csrf
...
<script>
    ...
    function atur_baseline(kegiatan_utama_id, indikator_id) {
        ...
        $('#hapus-baseline').hide();
        modal_baseline.show();
        $.getJSON("{{ url('renvana_aksi/rb-general/perencanaan/getData') }}/" + kegiatan_utama_id + "/" + indikator_id, function(data) {
    ...
    function atur_target(kegiatan_utama_id, indikator_id) {
        ...
        $('.saveButton').prop('disabled', true);
        modal_target.show();
        $.getJSON("{{ url('renvana_aksi/rb-general/perencanaan/getTarget') }}/" + kegiatan_utama_id + "/" + indikator_id, function(data) {
            if (data.success) {
    ...
    function tambah_dokumen(id) {
        ...
        $.getJSON("{{ url('renvana_aksi/rb-general/perencanaan/getDokumen') }}/" + id, function(data) {
