...
@section('content')
        ...
        <div id="questions-container">
            ...
            <div class="question-card" style="background-color: #ffffff; border: 1px solid #e2e8f0; border-left: 6px solid #2563eb; border-radius: 12px; margin-bottom: 24px; padding: 24px; box-shadow: 0 4px 6px -1px rgba(37, 99, 235, 0.1);">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; padding-top: 16px;">
                    <button type="button" onclick="toggleWajib(this)" data-active="false" style="display: flex; align-items: center; gap: 8px; border: 1px solid #cbd5e1; background-color: #f1f5f9; color: #64748b; padding: 6px 12px; border-radius: 8px; font-size: 13px; font-weight: 500; cursor: pointer;">
                        Jadikan Wajib
                    </button>
    ...
    <script>
        ...
        function addOption(btnObj, type) {
            ...
            newRow.innerHTML = `
                ${iconHtml}
                <input type="text" value="Opsi ${currentOptionsCount}" class="editable-input" onfocus="this.select()" style="flex: 1; font-size: 14px; color: #334155; padding: 10px 12px; margin-right: 8px;">
                <span class="delete-btn" onclick="deleteOption(this)">×</span>
            `;
        ...
        function saveForm() {
            ...
            cards.forEach((card) => {
                ...
                if (type === 'pilihan_ganda' || type === 'kotak_centang') {
                    ...
                    const optionInputs = activeView.querySelectorAll('.option-list input');
            ...
            .then(data => alert("Berhasil: " + data.message))
            .catch(error => {
