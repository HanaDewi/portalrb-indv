...
<div id="modal-kelola-anggota-tim" class="modal fade" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- BEGIN: Modal Body -->
            <form action="{{ route('kelola_anggota_tim_simpan') }}" id="form-kelola-anggota-tim" method="post">
                @csrf
...
<script>
    ...
    function getData() {
        anggota_tim_evaluasi.ajax.url("{{route('getData_anggotaTim')}}").load(null, false);
    }
    ...
    function hapus(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "{{url('/kelola-anggota-tim/hapus')}}",
                    type: "post",
