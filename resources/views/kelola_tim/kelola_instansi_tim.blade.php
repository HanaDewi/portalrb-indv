...
<div class="intro-y col-span-12 lg:col-span-12">
    ...
    <div class="intro-y box">
        <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60">
            <h2 class="font-medium text-base mr-auto"> Kelola instansi Tim</h2>
...
<div id="modal-kelola-instansi-tim" class="modal fade" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- BEGIN: Modal Body -->
            <form action="{{ route('kelola_instansi_tim_simpan') }}" id="form-kelola-instansi-tim" method="post">
                @csrf
                <input type="hidden" name="instansi_tim_id" id="anggota_tim_id">
...
<script>
    $(document).ready(function() {
        $('.instansiId').select2({
            dropdownParent: $("#modal-kelola-instansi-tim")
        });
        $('.namaTim').select2({
            dropdownParent: $("#modal-kelola-instansi-tim")
        });
        getData();
        modal_kelola_anggota_tim = tailwind.Modal.getInstance(document.querySelector("#modal-kelola-instansi-tim"));
        
        $('#form-kelola-instansi-tim').validate({
    ...
    function getData() {
        anggota_tim_evaluasi.ajax.url("{{route('getData_instansiTim')}}").load(null, false);
    }

    function clearForm() {
        $('#form-kelola-instansi-tim').trigger('reset');
    ...
    function hapus(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "{{url('/kelola-instansi-tim/hapus')}}",
                    type: "post",
