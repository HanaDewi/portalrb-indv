...
<div id="modal-kelola-tim" class="modal fade" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- BEGIN: Modal Body -->
            <form action="{{ route('kelola_tim_simpan') }}" id="form-kelola-tim" method="post">
                @csrf
...
<script>
    ...
    function getData() {
        tim_evaluasi.ajax.url("{{route('getData_tim')}}").load(null, false);
    }
    ...
    function edit(id) {
        ...
        $('.saveButton').prop('disabled', true);
        modal_kelola_tim.show();
        $.getJSON("{{url('kelola-tim/getData')}}/"+id, function(data) {
            $('#nama').val(data.nama);
