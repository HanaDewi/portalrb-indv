    ...
    <div class="col-span-12 grid grid-cols-12 gap-6">
                ...
                <a href="rencanaaksiuser.html">
                    <div class="flex items-center">
                        <div class="w-2/4 flex-none">
                            <div class="text-lg font-bold truncate">Total Artikel</div>
                            <div class="text-lg mt-5"> {{ $publishedArticle }}</div>
                        </div>
        ...
        <div class="col-span-12 sm:col-span-6 2xl:col-span-3 intro-y">
            <div class="box p-5 zoom-in">
                <a href="tematik.html">
                    <div class="flex items-center">
                        <div class="w-2/4 flex-none">
                            <div class="text-lg font-bold truncate">Pending Artikel</div>
                            <div class="text-lg mt-5">{{ $pendingArticle }}</div>
                        </div>
                        <div class="flex-none ml-auto relative">
                            <div class="w-[90px] h-[90px]">
                            ...
                            <div class="font-medium absolute w-full h-full flex items-center justify-center top-0 left-0">
                                <span><svg xmlns="http://www.w3.org/2000/svg" width="42" height="42"
                                        ...
                                        stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-file-bar-chart">
        ...
        <div class="col-span-12 sm:col-span-6 2xl:col-span-3 intro-y">
            <div class="box p-5 zoom-in">
                <a href="rb-general/perencanaan">
                    <div class="flex items-center">
                        <div class="w-2/4 flex-none">
                            <div class="text-lg font-bold truncate">Total Kategori</div>
        ...
        <div class="col-span-12 sm:col-span-6 2xl:col-span-3 intro-y">
            <div class="box p-5 zoom-in">
                <a href="inputrencanatematik.html">
                    <div class="flex items-center">
                        <div class="w-2/4 flex-none">
                            <div class="text-lg font-bold truncate">Total Sosial Media</div>
                            <div class="text-lg mt-5">{{ $socials }}</div>
                        </div>
                        <div class="flex-none ml-auto relative">
                            <div class="w-[90px] h-[90px]">
                            </div>
        ...
        <div class="col-span-12 sm:col-span-6 2xl:col-span-3 intro-y">
            <div class="box p-5 zoom-in">
                <div class="flex items-center">
                    <div class="w-2/4 flex-none">
                        <div class="text-lg font-bold truncate">Total Subscribers</div>
                        <div class="text-lg mt-5">
                            {{ $subscribers }}
                        </div>
                    </div>
